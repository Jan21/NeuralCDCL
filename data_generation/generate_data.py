...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_formulas", type=int, default=10, help="Number of formulas to generate traces from.")
    parser.add_argument("--n_vars_range", type=int, nargs=2, default=[10, 20], help="Range for number of variables (min max).")
    parser.add_argument(
        "--remap_variables", nargs="?", const=25, type=int, default=25,
