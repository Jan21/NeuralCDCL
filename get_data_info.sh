#!/bin/bash
#SBATCH --job-name=cdcl_data_info    # Job name
#SBATCH --output=logs/data_info/pythia_%j.out        # Standard output and error log (%j expands to jobID)
#SBATCH --error=logs/data_info/pythia_%j.err         # Error log
#SBATCH --time=1:05:00              # Time limit hrs:min:sec
...
singularity exec $SIF python utils/get_data_info.py